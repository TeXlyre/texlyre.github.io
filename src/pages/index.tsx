...
export default function Home(): ReactNode {
  ...
  return (
    <Layout
      ...
      description="The FOSS Local-First & Collaborative LaTeX/Typst Editor for the Web">
      <HomepageHeader />
      <main>
        <HomepageFeatures />
        <ProjectCarousel />
